...
class SCRFD:
    ...
    def detect(self, img, thresh=0.5, input_size=(160, 160), max_num=0, metric='default'):
...
if __name__ == '__main__':
    ...
    detector = SCRFD(model_file='models/scrfd_10g_bnkps.onnx')
    detector.prepare(0)
    ...
    for img_path in img_paths:
        ...
        for _ in range(10):
            ...
            bboxes, kpss = detector.detect(img, 0.5, input_size=(160, 160))
